...
import com.example.mongodb.service.MongoUserDetailsService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    final JWTUtilsService jwtUtils;
    final MongoUserDetailsService userService;

    public JwtAuthFilter(JWTUtilsService jwtUtils, MongoUserDetailsService userService) {
